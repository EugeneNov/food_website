...
// ! Javascript Object Notaishon - является текстовым форматом обмена данными, используется не только для передачи, но и для хранения данных (набор пар ключ: значение, все сущности ОБЯЗАТЕЛЬНО в двойных ковычках), преимущества маленький вес файлов и простота чтения для человека.

// const persone = {
// 	name: "Eugene",
// 	tel: "+72312434113",
// };
// const str = JSON.stringify(persone); //todo перевод данных из объекта в строку JSON для отправки на сервер

// console.log(str);
// console.log(JSON.parse(str)); //todo перевод данных типа из сервера в объект для работы с ними
